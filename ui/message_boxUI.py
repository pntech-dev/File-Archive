...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(360, 176)
        Dialog.setMinimumSize(QtCore.QSize(360, 176))
...
"}")
        ...
        self.message_frame = QtWidgets.QFrame(Dialog)
        ...
        self.action_pushButton.setMinimumSize(QtCore.QSize(100, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.message_text_label.setText(_translate("Dialog", "TextLabel"))
        self.action_pushButton.setText(_translate("Dialog", "Ок"))
